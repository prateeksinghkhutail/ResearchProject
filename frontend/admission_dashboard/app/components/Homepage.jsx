...
export default function Homepage() {
	...
	// 	const appNo = prompt('Enter your Application Number to Withdraw:');
	...
	const submitFile = async () => {
		...
		if (uploadType === 'master') {
			...
			endpoint = '/api/withdraw/upload'; // New backend endpoint for withdraws
		}
		...
		<div className='p-6'>
			...
			<div className='bg-gray-200 p-6 rounded-lg w-full mt-6 flex flex-col items-center'>
				...
				<div className='flex gap-4 mt-4'>
					...
					{/* New Withdraw CSV Upload Button */}
					<button
						className={`w-48 py-2 rounded ${
							uploadType === 'withdraw'
								? 'bg-green-600 text-white'
						...
						onClick={() => handleUpload('withdraw')}>
						Upload Withdraw List
					</button>
				</div>
				{uploadType && (
					<div
